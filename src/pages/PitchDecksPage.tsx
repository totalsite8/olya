...
import {
  PITCH_SERVICE_PILLARS,
  PITCH_SERVICE_PROCESS,
  PITCH_SERVICE_DELIVERABLES,
  PITCH_SERVICE_FAQ,
  PITCH_SERVICE_STORY,
    ...
    <section id="story" className="scroll-mt-24 px-6 py-24 sm:px-10 lg:px-16">
      <div className="mx-auto max-w-[1400px]">
        ...
        <StickyMediaStory
          ...
          renderMedia={(_, step) => (
            <div className="aspect-video w-full max-w-[560px] overflow-hidden rounded-3xl border border-[var(--color-border)] shadow-2xl">
