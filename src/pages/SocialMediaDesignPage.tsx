  ...
  return (
    <section className="relative border-y border-[var(--color-border)] px-6 py-28 sm:px-10 lg:px-16">
      ...
      <div className="mx-auto max-w-[1400px]">
        ...
        <h2 className="font-display max-w-2xl text-4xl font-semibold tracking-tight sm:text-6xl">Полная система для ленты бренда</h2>

        <div ref={ref} className="mt-16 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {SOCIAL_SERVICE_PILLARS.map(({ icon: Icon, title, description }) => (
            <div
              key={title}
